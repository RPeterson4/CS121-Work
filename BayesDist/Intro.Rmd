...
Assume we have two random variables, $X$ and $Y$. Bayes's theorem states that the conditional probability of $Y|X$ can be calculated from the reverse conditional $X|Y$:
