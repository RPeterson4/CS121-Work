...
Assume we have two random variables, $X$ and $Y$. Bayes's theorem states that the conditional probability $Y|X$ can be derived from the reverse conditional $X|Y$:
